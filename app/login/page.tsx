    ...
    <main className="max-w-md mx-auto px-6 py-20 flex flex-col justify-center min-h-[80vh]">
      <div className="space-y-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-widest uppercase">Login</h1>
          <p className="text-[10px] text-accent font-bold tracking-[0.2em] uppercase">Enter your credentials to continue</p>
        </div>
        ...
        <form action={login} className="space-y-6">
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="password" title="Enter your password" underline className="block text-[10px] font-bold text-accent uppercase mb-2 tracking-widest">Password</label>
              <input
                id="password"
                name="password"
                type="password"
          ...
          <div className="space-y-4">
            ...
            <div className="text-center">
              <Link href="/signup" className="text-[10px] font-bold text-accent hover:text-foreground underline underline-offset-4 uppercase tracking-widest">
