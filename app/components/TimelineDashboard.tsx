  ...
  return (
    <StaggerItem>
      <div className="relative pl-8 group py-8 transition-all duration-500">
        ...
        <div className="space-y-4 bg-card/40 backdrop-blur-sm p-6 rounded-2xl border border-transparent hover:border-action/30 hover:bg-card/60 transition-all duration-500">
          ...
          {timelineComments[event.id] && timelineComments[event.id].length > 0 && (
            <div className="space-y-2 mt-4 ml-2">
              {timelineComments[event.id].map((comm: any, idx: number) => (
                <div key={idx} className="flex flex-col gap-1 border-l-2 border-action/30 pl-4 py-1">
