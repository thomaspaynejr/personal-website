    ...
    <main className="max-w-md mx-auto px-6 py-20 flex flex-col justify-center min-h-[80vh]">
      <div className="space-y-6 bg-card/40 backdrop-blur-md p-6 rounded-2xl border border-border-custom/30 shadow-xl">
        <div className="space-y-1">
          <h1 className="text-2xl font-bold tracking-widest uppercase">Sign Up</h1>
          <p className="text-[10px] text-accent font-bold tracking-[0.2em] uppercase opacity-70">Create an account to join</p>
        </div>
        ...
        <form action={signup} className="space-y-5">
          <div className="space-y-3">
            ...
            <div>
              <label htmlFor="password" title="Create a password" className="block text-[10px] font-bold text-accent uppercase mb-1.5 tracking-widest">Password</label>
              <input
                id="password"
                name="password"
                type="password"
          ...
          <div className="space-y-3">
            ...
            <div className="text-center">
              <Link href="/login" className="text-[9px] font-bold text-accent hover:text-foreground underline underline-offset-4 uppercase tracking-widest">
